 ...
 * @author Asus
 */
@WebServlet(name="SearchSettingURL", urlPatterns={"/SearchSettingURL"})
public class SearchSettingURL extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int totalSetting = dao.getTotalSearchSetting(txt);
        ...
        if(!dao.isSettingListEmpty(txt, page, PAGE_SIZE)){
            List<Map<String, Object>> searchResult = dao.searchSettingList(txt, page, PAGE_SIZE);
