 ...
 * @author hieul
 */
@WebServlet(name = "DeleteQuestionSetController", urlPatterns = {"/DeleteQuestionSetURL"})
public class DeleteQuestionSetController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            DAONormalQuestion normalQuestionDAO = new DAONormalQuestion();
            DAONormalQuestionAnswer normalQuestionAnswerDAO = new DAONormalQuestionAnswer();
