...
public class AuthenticationFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        try {
            ...
            if (session == null || session.getAttribute("acc") == null) { // ~ if NOT: session already has user => try to AUTO-LOGIN with USER
                ...
                if (cookieUsername != null && cookiePassword != null) {
                    result = dao.checkUserObj(cookieUsername, EncryptionUtils.toMD5(cookiePassword));
                    if (result != null) {
